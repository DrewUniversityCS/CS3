# Generated by Django 3.1.6 on 2021-02-25 21:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TeacherTimeBlockPreference',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='database.TeacherCoursePreference', to='database.Course'),
        ),
        migrations.AddField(
            model_name='teacher',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='database.TeacherRoomPreference', to='database.Room'),
        ),
        migrations.AddField(
            model_name='teacher',
            name='time_preferences',
            field=models.ManyToManyField(through='database.TeacherTimeBlockPreference', to='database.TimeBlock'),
        ),
        migrations.AddField(
            model_name='teacher',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('weight', models.FloatField(default=0.5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1.0)])),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.course')),
        ...
        migrations.AddField(
            model_name='student',
            name='class_preferences',
            field=models.ManyToManyField(through='database.StudentCoursePreference', to='database.Course'),
        ),
        migrations.AddField(
            model_name='student',
            name='user',
        ...
        migrations.CreateModel(
            name='CourseTimeBlockPreference',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('weight', models.FloatField(default=0.0, validators=[django.core.validators.MinValueValidator(-1.0), django.core.validators.MaxValueValidator(1.0)])),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.course')),
        ...
        migrations.AddField(
            model_name='course',
            name='room_preferences',
            field=models.ManyToManyField(through='database.CourseRoomPreference', to='database.Room'),
        ),
        migrations.AddField(
            model_name='course',
            name='time_preferences',
            field=models.ManyToManyField(through='database.CourseTimeBlockPreference', to='database.TimeBlock'),
        ),
    ]
