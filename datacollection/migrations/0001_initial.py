    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_set',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_form',
                                   to='database.modelset')),
                ('student_set',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_form',
                                   to='database.modelset')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preference_form',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entries',
                                   to='datacollection.preferenceform')),
            ],
        ),
    ]
